...
export default function AdminLogin() {
  ...
  return (
    <main className="min-h-screen bg-[#070b16] p-5 text-slate-100">
      <div className="mx-auto grid min-h-[calc(100vh-2.5rem)] max-w-5xl overflow-hidden rounded-3xl border border-white/10 bg-[#10182b] shadow-2xl lg:grid-cols-[1.1fr_.9fr]">
        <section className="hidden bg-[radial-gradient(circle_at_top_right,#4f46e5,transparent_45%),linear-gradient(145deg,#111c39,#0d1325)] p-10 lg:block">
          ...
          <p className="mt-5 max-w-sm text-sm leading-6 text-slate-400">
            Secure administration for users, verification, operations, finance, and CMS content.
          </p>
        </section>
        <section className="flex items-center p-7 sm:p-12">
          <div className="w-full">
            ...
            <p className="mt-8 text-xs font-bold uppercase tracking-[.2em] text-indigo-400">
              Administrator sign in
            </p>
            <h2 className="mt-2 font-display text-3xl font-bold">Welcome back</h2>
            <p className="mt-2 text-sm text-slate-400">
              Use your private administrator credentials.
            </p>
