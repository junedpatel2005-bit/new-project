            ...
            <div className="grid gap-6 xl:grid-cols-[1.2fr_.8fr]">
              ...
              <aside className="rounded-2xl border border-border bg-card p-6 shadow-soft">
                ...
                <ol className="mt-4 space-y-4 text-sm text-muted-foreground">
                  <li>
                    <span className="mr-2 font-semibold text-primary">1.</span>A professional
                    submits their milestone work.
                  </li>
                  <li>
                    <span className="mr-2 font-semibold text-primary">2.</span>You review and
                    approve the milestone.
                  </li>
                  <li>
                    <span className="mr-2 font-semibold text-primary">3.</span>The approved amount
                    is recorded and released to the professional.
                  </li>
                </ol>
