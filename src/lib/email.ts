...
<html lang="en">
  <body style="margin:0;background:#f8fafc;font-family:Arial,Helvetica,sans-serif;color:#0b1f4d">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0">Confirm your Servio account email.</div>
      ...
      <tr><td align="center" style="padding:40px 16px">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;background:#ffffff;border:1px solid #e2e8f0;border-radius:16px">
          <tr><td style="padding:28px 32px;border-bottom:1px solid #eef2f7">
            <div style="font-size:24px;font-weight:700;letter-spacing:-.4px;color:#1748b5">Servio</div>
          </td></tr>
          <tr><td style="padding:56px 32px 48px;text-align:center">
            ...
            <p style="margin:0 0 28px;color:#627d98;font-size:14px;line-height:1.5">Click the button to activate your Servio account.</p>
          ...
          <tr><td style="padding:20px 32px;border-top:1px solid #eef2f7;text-align:center;color:#829ab1;font-size:12px;line-height:1.5">If you did not create this account, you can safely ignore this email.<br>© 2026 Servio, Inc.</td></tr>
        </table>
      </td></tr>
    </table>
  </body>
